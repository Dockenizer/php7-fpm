...
RUN apk --repository http://dl-3.alpinelinux.org/alpine/edge/community/ \
     ...
     apk --repository http://dl-3.alpinelinux.org/alpine/edge/community/ \
        ...
        --repository http://dl-3.alpinelinux.org/alpine/edge/testing/ \
        --update \
        add bash  openssl icu icu-dev curl libtool imagemagick-dev make g++ autoconf perl rabbitmq-c-dev freetype-dev libjpeg-turbo-dev libmcrypt-dev libpng-dev pcre-dev libxml2-dev && \
