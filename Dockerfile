...
RUN apk --repository http://dl-3.alpinelinux.org/alpine/edge/community/ \
        ...
        --update \
        add bash shadow openssl icu icu-dev curl libtool imagemagick-dev make g++ autoconf perl rabbitmq-c-dev freetype-dev libjpeg-turbo-dev libmcrypt-dev libpng-dev && \
